...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/a3387146-3ca1-4a5a-aaf6-4170d5253624">available here</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=1444828305810485&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F02-DLT-Loan-pipeline-PYTHON&uid=6938931879631087">
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/a3387146-3ca1-4a5a-aaf6-4170d5253624">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
...
# MAGIC
# MAGIC <a href="https://e2-demo-field-eng.cloud.databricks.com/sql/dashboards/003349c1-ac63-4096-a560-4c2c7981a62c-dlt---retail-data-quality-stats?o=1444828305810485" target="_blank">Data Quality Dashboard example</a>
